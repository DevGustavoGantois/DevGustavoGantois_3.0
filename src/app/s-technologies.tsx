        ...
        <section className="max-w-[1500px] p-6 lg:p-0 mx-auto mt-20 lg:mt-40 mb-4 lg:mb-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8 lg:gap-16 mt-10">
                <div className="flex items-center justify-center gap-3 text-white">
                    <FaReact className="text-5xl md:text-4xl lg:text-7xl" />
                    <p className="font-secondary hidden md:flex lg:text-4xl">React</p>
                </div>
                <div className="flex items-center justify-center gap-3 text-white">
                    <FaAngular className="text-5xl md:text-4xl lg:text-7xl" />
                    <p className="font-secondary hidden md:flex lg:text-4xl">Angular</p>
                </div>
                <div className="flex items-center justify-center gap-3 text-white">
                    <FaSass className="text-5xl md:text-4xl lg:text-7xl" />
                </div>
                <div className="flex items-center justify-center gap-3 text-white">
                    <FaNode className="text-5xl md:text-4xl lg:text-7xl" />
                </div>
                <div className="flex items-center justify-center gap-3 text-white">
                    <FaVuejs className="text-5xl md:text-4xl lg:text-7xl" />
                    <p className="font-secondary hidden md:flex lg:text-4xl">Vue.js</p>
                </div>
                <div className="flex items-center justify-center gap-3 text-white">
                    <FaFigma className="text-5xl md:text-4xl lg:text-7xl" />
                ...
                <div className="flex items-center justify-center gap-3 text-white">
                    <FaGitAlt className="text-5xl md:text-4xl lg:text-7xl" />
                    <p className="font-secondary hidden md:flex lg:text-4xl">Git</p>
                </div>
                <div className="flex items-center justify-center gap-3 text-white">
                    <FaHtml5 className="text-5xl md:text-4xl lg:text-7xl" />
                    <p className="font-secondary hidden md:flex lg:text-4xl">HTML</p>
                </div>
                <div className="flex items-center justify-center gap-3 text-white">
                    <FaCss3 className="text-5xl md:text-4xl lg:text-7xl" />
